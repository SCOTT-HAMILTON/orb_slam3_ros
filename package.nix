...
{ lib, buildRosPackage, catkin, cv-bridge, dynamic-reconfigure, image-transport, message-generation, message-runtime, nav-msgs, roscpp, rospy, sensor-msgs, std-msgs, tf, tf2-geometry-msgs, tf2-ros, visualization-msgs, pangolin, eigen, fetchFromGitHub, gcc }:
buildRosPackage {
  ...
  buildType = "catkin";
  buildInputs = [ catkin message-generation eigen gcc ];
